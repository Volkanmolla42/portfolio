...
const About = () => {
  return (
    <div className="container size-full flex flex-col  tracking-wider justify-between items-center  ">
      <div className="px-6 md:px-20 md:py-14 flex text-xs  overflow-y-auto scrollbar-thin scrollbar-thumb-red-700 scrollbar-track-gray-800  scroll-smooth   size-full">
        <div className="w-full ">
          ...
          <p className="text-gray-300 leading-relaxed mb-1">
            ...
            focused on delivering exceptional user experiences. My passion for
            web technologies and modern design trends drives me to push the
            boundaries and improve with every project. I have a solid foundation
            in
            <span className="font-medium text-gray-100">
              HTML, CSS, and JavaScript
            </span>
            , and I&apos;m skilled at solving complex challenges with modern
            tools like
            <span className="font-medium text-gray-100">
          ...
          <p className="text-gray-300 leading-relaxed mb-4">
            ...
            and <span className="font-medium text-gray-100">accessible</span>.
            My goal is to create projects that enhance brands&apos; digital
            presence, simplify users&apos; lives, and align with business
            objectives.
          </p>
          <p className="text-gray-300 leading-relaxed mb-4">
            My strengths in
