...
const TechStack = () => {
  return (
    <div className="w-full h-svh overflow-hidden bg-gradient-to-bl from-gray-900 via-purple-950 to-red-900  ">
      <div className=" size-full px-4 flex flex-col  items-center justify-center ">
